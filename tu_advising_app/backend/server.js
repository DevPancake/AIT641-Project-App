...
const data = [
    //These are the non computer science major classes. Don't need to be taken by computer science majors
    {
    ...
    //These are the core classes that everyone must take
    {
